...
# This script automates the process of importing disk images into Virtuliser VE virtual machines (VMs), 
...
# - Pick a storage volume in Virtuliser for disk placement.
