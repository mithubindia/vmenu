...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { href: "https://github.com/MacRimi/Vmenu-X", icon: <Github className="h-4 w-4" />, label: "GitHub" },
  ]
        ...
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center space-x-2">
            <Image
              ...
              className="w-8 h-8"
            />
            <span className="text-xl font-bold">Vmenu-X</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
            ...
            {/* RSS Feed Link */}
            <Link
              href="https://macrimi.github.io/Vmenu-X/rss.xml"
