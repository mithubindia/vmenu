    ...
    <div className="bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <section className="md:hidden py-20 px-4 sm:px-6 text-center">
        ...
        <p className="text-base sm:text-lg mb-8 max-w-4xl mx-auto text-gray-300">
          Vmenu-X is a management tool for Proxmox VE that simplifies system administration through an interactive
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center">
            <div className="w-40 h-40 lg:w-48 lg:h-48 xl:w-56 xl:h-56 relative">
              <Image
                src="https://raw.githubusercontent.com/MacRimi/Vmenu-X/main/images/logo.png"
                alt="Vmenu-X Logo"
                fill
            ...
            <div className="text-left max-w-md lg:max-w-lg xl:max-w-xl">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight">Vmenu-X</h1>
