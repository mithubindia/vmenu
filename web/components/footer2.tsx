      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="flex items-start mb-8 md:mb-0">
            ...
            >
              <Image
                src="https://raw.githubusercontent.com/MacRimi/Vmenu-X/main/images/kofi.png"
          ...
          <div className="flex flex-col items-start md:items-end">
            ...
            <Link
              href="https://github.com/MacRimi/Vmenu-X/discussions"
        ...
        <p>
          Vmenu-X, an open-source and collaborative project by{' '}
          <a
