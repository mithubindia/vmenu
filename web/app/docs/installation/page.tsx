...
export default function InstallationPage() {
  const installationCode = `bash -c \"$(wget -qLO - https://raw.githubusercontent.com/MacRimi/vmenu/main/install_proxmenux.sh)\"`
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-8 text-gray-900">
      ...
      <div className="w-full mb-4">
        ...
        <div className="my-4 text-sm">
          ...
          <p className="flex items-center mb-2">
            ...
            <span>You can <a href="https://github.com/MacRimi/vmenu/blob/main/install_proxmenux.sh" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">review the source code</a> before execution.</span>
          </p>
          <p className="flex items-center">
            <Shield className="h-4 w-4 text-green-500 mr-2 flex-shrink-0" />
            <span>All executable links follow our <a href="https://github.com/MacRimi/vmenu?tab=coc-ov-file#-2-security--code-responsibility" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Code of Conduct</a>.</span>
          </p>
        </div>
   
      <p className="mt-8 mb-4">During installation, vmenu will automatically install and configure the following dependencies:</p>
      ...
      <div className="w-full mb-4">
        <Image src="https://macrimi.github.io/vmenu/install/install.png" alt="vmenu Installation" width={800} height={400} className="rounded shadow-lg" />
      </div>

      <h2 className="text-xl font-semibold mt-6 mb-2">How to Use</h2>
      <p className="mb-2">Once installed, launch <strong>vmenu</strong> by running:</p>
      <div className="w-full mb-4">
      ...
      <p className="mb-4">
        On the first execution, you will be prompted to define the language for vmenu. The recommended language is English. Translations are generated automatically using a predefined translation package and Google Translate. Automatic translations may contain errors, so English is the preferred language for accuracy.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">Uninstalling vmenu</h2>
      <p className="mb-4">
        If you ever need to uninstall vmenu, there is a function in the Settings section designed for this purpose. For detailed instructions on how to uninstall, please refer to the{" "}
      ...
      <p className="mb-4">
        ...
        <a href="https://github.com/MacRimi/vmenu/issues" className="text-blue-600 hover:underline">
          GitHub Issues
        </a>{" "}
