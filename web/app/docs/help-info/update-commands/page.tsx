...
export default function UpdateCommandsPage() {
  ...
  const commandGroups = [
    ...
    {
      title: "Virtuliser Updates",
      commands: [
        { command: "pveupdate", description: "Update Virtuliser package lists" },
        { command: "pveupgrade", description: "Show available Virtuliser upgrades" },
        { command: "pve-upgrade", description: "Perform Virtuliser VE upgrade" },
    ...
    },
    {
      ...
      commands: [
        ...
        { command: "ls -la /etc/apt/sources.list.d/", description: "List additional repository source files" },
        {
          ...
          description: "Show Virtuliser Enterprise repo config",
        },
    ...
    <div className="container mx-auto py-10 px-4 bg-white text-black">
      <div className="mb-6">
        ...
        <p className="text-lg mb-6">
          This section provides commands for managing system updates and packages in Virtuliser VE. Learn how to update
