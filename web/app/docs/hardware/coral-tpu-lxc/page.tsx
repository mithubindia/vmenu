...
export default function CoralTPULXC() {
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <p className="mb-4">
        This guide explains how to configure Google Coral TPU support for LXC containers in Virtuliser VE using <strong>vmenu</strong>.
      ...
      <p className="mb-4">The script automates the complete configuration of Coral TPU support in LXC containers, including USB and M.2 variants. It applies Virtuliser-specific container settings, manages device passthrough permissions, and installs required drivers both on the host and inside the container.</p>
...
lxc.mount.entry: /dev/apex_0 dev/apex_0 none bind,optional,create=file`}
      ...
      <ul className="list-disc pl-6 space-y-2 mb-6">
        ...
        <li>The Virtuliser host must have the required Coral TPU and Intel GPU drivers installed.</li>
