<div align="center">
    <img src="https://github.com/MacRimi/Vmenu-X/blob/main/images/main.png"
         alt="Vmenu-X Logo"
...
**Vmenu-X** is a management tool for **Proxmox VE** that simplifies system administration through an interactive menu, allowing you to execute commands and scripts with ease.
...
```bash
bash -c "$(wget -qLO - https://raw.githubusercontent.com/MacRimi/Vmenu-X/main/install_vmenux.sh)"
```
...
📄 You can [review the source code](https://github.com/MacRimi/Vmenu-X/blob/main/install_vmenux.sh) before execution.

🛡️ All executable links follow our [Code of Conduct](https://github.com/MacRimi/Vmenu-X?tab=coc-ov-file#-2-security--code-responsibility).

---

## 📌 How to Use
Once installed, launch **Vmenu-X** by running:
...
## ⭐ Support the Project!
If you find **Vmenu-X** useful, consider giving it a ⭐ on GitHub to help others discover it!
